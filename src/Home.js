...
import logotop from './img/logo-ALTA@2x.png';
import profilimg from './img/matthew-hamilton-tNCH0sKSZbA-unsplash.jpg';
        ...
        <div className="home-background">
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-8 col-md-12 col-sm-12 col-12">
                            <div className="alterra">
                                <a href="index.html"><img className="logo-atas" src={logotop} alt='logo-top' /></a>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-12 col-sm-12 col-12">
                            <div className="row align-items-center navig">
                                ...
                                <div className="col-lg-3 col-md-3 col-sm-3 text-md-center text-sm-center text-lg-left"><a href="index.html">EXPERIENCE</a></div>
            ...
            <div className="container h-100">
                <div className="row align-items-center isi-home">
                    <div className="col-lg-4 col-md-12 col-sm-12  col-12">
                        <img id="foto-profil" src={profilimg} alt='foto-profil' />
                    </div>
                    <div className="col-lg-8 col-md-12 col-sm-12 col-12">
